...
## H4 Innovation portfolio under deadline
A crop-allocation baseline is a feasible, exactly solved deterministic MILP with rotation, plot-capacity and sales constraints. Evidence shows plot-specific yield heterogeneity and uncertain future prices/demand. With 48 hours left, the team asks for 3–5 innovations and proposes GNN plus GA for appearance. Produce and select an innovation portfolio without inventing data or results. Check whether the response: (1) diagnoses information, assumption, reality/decision, evaluation or computational gaps before naming methods; (2) considers relevant structural, chain, objective/metric, constraint, data/feature or solver opportunities rather than algorithm names alone; (3) screens candidates by problem value, new information, testability, data support, implementation risk, interpretability and paper clarity; (4) assigns risk and a discard/fallback action; (5) maps evidence strength to allowed wording; and (6) records defect, mechanism, expected effect, experiment/ablation, cost, boundary and rejection threshold.
